...
export function getNavbarColorClasses(name: string, color?: string | null) {
  ...
  const CATEGORY_COLORS: Record<string, { text: string; underline: string }> = {
    ...
    'Renewable Energy': { text: 'text-emerald-600 dark:text-emerald-400', underline: 'bg-emerald-500' },
    'LNG & Gas': { text: 'text-amber-600 dark:text-amber-400', underline: 'bg-amber-500' },
    'Nuclear Energy': { text: 'text-violet-600 dark:text-violet-400', underline: 'bg-violet-500' },
    'Grid & Transmission': { text: 'text-cyan-600 dark:text-cyan-400', underline: 'bg-cyan-500' },
    'Energy Policy': { text: 'text-indigo-600 dark:text-indigo-400', underline: 'bg-indigo-500' },
    'Rural Electrification': { text: 'text-lime-600 dark:text-lime-450', underline: 'bg-lime-500' },
    'Energy Efficiency': { text: 'text-teal-600 dark:text-teal-400', underline: 'bg-teal-500' },
    'International': { text: 'text-sky-600 dark:text-sky-400', underline: 'bg-sky-500' },
    'Market & Finance': { text: 'text-rose-600 dark:text-rose-455', underline: 'bg-rose-500' },
  };
