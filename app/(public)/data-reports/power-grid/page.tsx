...
export default function PowerGridExplorer() {
  ...
  return (
    <div className="container py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-8">
        {[
          { label: 'Installed Capacity', val: '28.4 GW', icon: Zap },
          { label: 'Today Peak Demand', val: '17.2 GW', icon: Activity },
          { label: 'Renewables Online', val: '1.42 GW', icon: Zap },
      ...
      {activeTab === 'mix' && (
        <div className="card p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="text-xs px-3.5 py-1 bg-muted border border-border/40 rounded-full font-bold uppercase tracking-wider text-muted-foreground">Total 28.4 GW</div>
          </div>
