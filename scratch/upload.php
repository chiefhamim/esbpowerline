...
// Since upload.php is uploaded to the root of CDN mapping (/public_html/uploads/),
// store files in the relative directory: uploads/library/ or uploads/categories/
