    ...
    data: [
      ...
      },
      {
        ...
        value: [
          ...
          { label: 'Current Demand', value: 16154, unit: 'MW', icon: 'Activity', color: '#ef4444' },
          { label: 'Renewable Share', value: 7.2, unit: '%', isDecimal: true, icon: 'Leaf', color: '#10b981' },
          { label: 'System Loss', value: 7.6, unit: '%', isDecimal: true, icon: 'Gauge', color: '#f59e0b' },
          { label: 'Gas Supply', value: 907, unit: 'MMcfd', icon: 'Flame', color: '#8b5cf6' },
          { label: 'Peak Today', value: 16854, unit: 'MW', icon: 'TrendingUp', color: '#3b82f6' },
          { label: 'India Grid Import', value: 2584, unit: 'MW', icon: 'Cable', color: '#06b6d4' },
          { label: 'Solar Installed', value: 1512, unit: 'MW', icon: 'Sun', color: '#f59e0b' },
        ],
      },
      {
        key: 'interviews',
