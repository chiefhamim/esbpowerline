...
import { bulkArticleAction, type BulkArticleAction } from '@/lib/actions/articles';
...
function authorId(a: AdminArticleRow) {
  return typeof a.author === 'string' ? a.author : a.author?.id ?? '';
}
...
export function AdminArticleManager({
  ...
  function executeBulk(
    ...
    startTransition(async () => {
      try {
        const res = await bulkArticleAction(targetIds, action, options);
