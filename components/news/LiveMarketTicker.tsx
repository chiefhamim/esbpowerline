...
export function LiveMarketTicker({ initialItems: propItems }: { initialItems?: TickerItem[] }) {
  ...
  return (
    <div className="w-full border-b border-border/70 bg-[var(--bg-elev)]/60 backdrop-blur-sm overflow-hidden">
      <div className="container flex items-center h-9 text-[11px]">
