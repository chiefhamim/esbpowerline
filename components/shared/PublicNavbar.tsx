      ...
      <nav className="public-nav-bar sticky top-0 z-50 mb-2">
        ...
        {mobileOpen && (
          <div className="md:hidden border-t border-border/70 public-nav-bar px-4 py-4 text-sm space-y-1">
            <PublicNavLink href="/articles" className="flex items-center gap-2 py-1.5"><Newspaper className="h-4 w-4" /> Latest News</PublicNavLink>
            <PublicNavLink href="/data-reports/power-grid" className="flex items-center gap-2 py-1.5"><BarChart3 className="h-4 w-4" /> Grid Explorer</PublicNavLink>
            <PublicNavLink href="/magazine" className="flex items-center gap-2 py-1.5 text-emerald-600/90 dark:text-emerald-400/90">
              <BookOpen className="h-4 w-4" />
              Monthly Magazine
            </PublicNavLink>
            <PublicNavLink href="/search" className="flex items-center gap-2 py-1.5"><Search className="h-4 w-4" /> Search Articles</PublicNavLink>
            <MemberNavMenuLinks />
          </div>
        )}
      </nav>
