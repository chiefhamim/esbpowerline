...
export function PublicFooter({ categories = [] }: { categories?: PublicCategory[] }) {
  ...
  const exploreLinks = [
    ...
    { label: 'Monthly Magazine', href: '/magazine' },
    { label: 'Grid Explorer', href: '/data-reports/power-grid' },
      ...
      <div className="container py-10 md:py-12">
        ...
        <div className="grid grid-cols-1 gap-10 pt-8 sm:grid-cols-2 lg:grid-cols-12 lg:gap-x-8 lg:gap-y-0">
          <section className="lg:col-span-4">
            <FooterHeading>Editorial & Office</FooterHeading>
            <div className="space-y-4">
              <ContactItem icon={UserRound} label="Editor & Publisher">
              ...
              <ContactItem icon={Phone} label="Advertising Department">
                <a href="tel:+8801711378733" className="transition-colors hover:text-primary">
                  +8801711-378733
                </a>
              </ContactItem>

              <ContactItem icon={Share2} label="Official channels">
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 border-t border-border/40 pt-6 text-xs text-foreground/55 md:grid-cols-3 md:items-center">
          <p className="text-center md:text-left">© {year} ESB PowerLine. All rights reserved.</p>
          <p className="text-center leading-relaxed text-foreground/60">
